document.addEventListener('DOMContentLoaded', () => {
  ...
  function createPlayer(playerName) {
    ...
    // Permite selecionar o jogador clicando
    playerContainer.addEventListener('click', (e) => {
      // Evita que o clique em botões internos dispare a seleção
  ...
  function removePlayer() {
    ...
    const playerName = selectedPlayer.querySelector('h2').innerText;
    const confirmDelete = confirm(`Deseja realmente remover o jogador "${playerName}"?`);
